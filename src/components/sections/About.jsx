...
const About = () => {
  ...
  const skills = ["JavaScript (ES6+)", "TypeScript", "React", "Angular"];
        ...
        <StyledText>
          <div>
            ...
            <p>
              ...
              craft. My goal is to apply the knowledge I’ve gained at UIT to
              build elegant, responsive, and intuitive interfaces that delight
